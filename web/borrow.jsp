...
<div class="borrowinfo">
    ...
    <form action="IOAction?action=borrow" onsubmit="return errorsubmit()" method="post">
        <div>
            <span class="infotitle">ID Miembro：</span><input type="text" onkeyup="readercheck()" name="readerid"
                                                             id="readerid"><span id="readeridcheck"
                                                                                 class="error"></span>
        </div>
        <div>
        ...
        <div>
            <span class="infotitle">Status：</span><input type="text" name="readername" id="readerstatus" disabled><span
                id="readerstatuscheck" class="error"></span>
        </div>
        <div>
            <span class="infotitle">Libros en posesion：</span><input type="text" name="readerborrow" id="readerborrow"
                                                                     disabled><span id="readerborrowcheck"
                                                                                    class="error"></span>
        </div>
        <div>
            <span class="infotitle">ID Libro：</span><input type="text" name="bookid" onkeyup="bookcheck()"
                                                           id="bookid"><span id="bookidcheck" class="error"></span>
        </div>
        <div>
        ...
        <div>
            <span class="infotitle">Editorial：</span><input type="text" name="bookpublisher" id="bookpublisher"
                                                            disabled>
        </div>
        <div>
            <span class="infotitle">Disponible：</span><input type="text" name="bookremain" id="bookremain"
                                                             disabled><span id="booknumcheck" class="error"></span>
        </div>
        <div>
